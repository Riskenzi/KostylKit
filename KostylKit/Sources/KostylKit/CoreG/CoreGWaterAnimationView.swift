...
open class CoreGWaterAnimationView: UIView {
    ...
    open var maskImage: UIImage? {
        didSet {
            ...
            maskLayer?.contentsGravity = .resizeAspect //.resizeAspect
    ...
    public convenience init(frame: CGRect, frontColor: UIColor? = #colorLiteral(red: 0.1529411765, green: 0.7960784314, blue: 1, alpha: 1), backColor: UIColor? = #colorLiteral(red: 0.1529411765, green: 0.7960784314, blue: 1, alpha: 1)) {
        self.init(frame: frame)
